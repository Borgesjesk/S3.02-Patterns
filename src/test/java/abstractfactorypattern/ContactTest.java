...
class ContactTest {
    ...
    void testSpainContact() {
        ...
        assertEquals("Address: Carrer Major 34, 08001 Barcelona | Phone: +34 123 45 67 89", contact.toString());
    }
    ...
    void testUSAContact() {
        ...
        Contact contact = new Contact(factory);
        assertEquals("Address: 154 5th Avenue, New York, NY 10001 | Phone: +1 (098) 765-4321", contact.toString());
    }
}